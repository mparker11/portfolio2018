    ...
    render() {
        return (
            <div className="mobile-page page">
                ...
                <a className="mobile-resume-button" target="_blank" href="https://firebasestorage.googleapis.com/v0/b/portfolio-v7.appspot.com/o/files%2FMartavisResume2018.pdf?alt=media&token=69d5280b-9992-406e-875d-ff3edc2a1966">View Resume</a>
            </div>
        );
    }
}
